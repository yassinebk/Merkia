...
const Landing = () => {
  ...
  return (
        <Container className="  h-screen w-screen ">
            <Navbar/>
            <div className="   flex flex-col  flex-nowrap items-center justify-around mt-24 md:mt-48 w-4/6 px-2 w-full py-4  ">
                <div
                    className={
                        ' flex flex-col justify-center px-0 space-y-6 w-full profile-horizontalCard landing-max-dimension m-auto ' +
                        ' md:space-y-16 ' +
                        'lg:grid  lg:grid-cols-2   space-x-0   py-0 h-1/3 items-center   mb-16 '

                    }
                >
                    <div className="  lg:col-start-1 lg:col-end-2  px-2 h-2/6 w-full lg:w-auto  lg:m-auto  ">

                        <img src={hero} className="py-8 w-full"/>
                    </div>
                    ...
                    <div
                        className="flex flex-row justify-evenly  w-full h-1/3 col-start-2 col-end-3 mt-0 lg:mr-48">
                        <Button
                            variant="primary"
                ...
                <div className="w-screen bg-light my-0 h-full mb-0">
                    <div
                        className=" flex  flex-col content-center items-center p-8  w-screen h-auto space-y-2 md:space-y-8  ">
                        <div>
                            <h3 className=" md:hidden text-3xl">We offer you a <span className="text-primary_100">unique</span> experience</h3>
                            ...
                            <ul className=" flex flex-col md:flex-row  md:justify-evenly align-center list-none md:space-x-10">
                                ...
                                >
                                    <img src={minimalImg} className={cardImages}/>
                                    <h3 className={cardTitle}>A minimalist Design</h3>
                                    <p className={cardText}> You will be amazed with our minimalist Design</p>
                                </li>
                                <li className={card}>
                                    <img src={robustImg} className={cardImages}/>
                                ...
                                <li className={card}>
                                    <img src={friendsImg} className={cardImages}></img>
                        ...
                        <Button variant="outlined" classes= " border-1 border-secondary_100 hover:border-2  my-4 h-24 text-3xl text-black mb-12 " text="Read our Docs">
                        </Button>
                        <Footer/>
                    </div>
                </div>
