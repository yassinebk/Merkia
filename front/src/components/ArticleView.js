...
const ArticleView = (props) => {
  useEffect(async () => {
    ...
    await props.getArticle(props.match.params.id)
    return () => {
      document.body.className = ''
    }
  })

  const { text, claps, title, feature_img, author } = props._article
            ...
            <div className="post-stats clearfix">
              <div className="pull-left">
                <div className="like-button-wrapper">
                  <button
                    onClick={() => props.clap(props._article._id)}
